...
```powershell
New-Item -ItemType File -Force -Path frontend\app\api\nearest-grit-bin\route.ts | Out-Null
```

Open `frontend/app/api/nearest-grit-bin/route.ts` in your editor and type the contents below yourself.
